...
def setup_argparse():
    ...
    parser.add_argument('--num-train', type=int, default=80, metavar='N',
                        help='Number of samples to train on. Set to -1 to use entire dataset. (default: -1)')
    parser.add_argument('--num-valid', type=int, default=20, metavar='N',
                        help='Number of validation samples to use. Set to -1 to use entire dataset. (default: -1)')
    parser.add_argument('--num-test', type=int, default=20, metavar='N',
    ...
    parser.add_argument('--batch-size', '-bs', type=int, default=20, metavar='N',
